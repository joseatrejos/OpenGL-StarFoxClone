...
NaveStarFox::NaveStarFox() {
	...
	//hit box
	//izquierda
	vertices.push_back({ vec4(-0.8f, 0.9f, -1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	vertices.push_back({ vec4(1.0f, 0.9f, -1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	vertices.push_back({ vec4(1.0f, -0.8f, -1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	vertices.push_back({ vec4(-0.8f, -0.8f, -1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	//derecha
	vertices.push_back({ vec4(-0.8f, 0.9f, 1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	vertices.push_back({ vec4(1.0f, 0.9f, 1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
	vertices.push_back({ vec4(1.0f, -0.8f, 1.2f, 1.0f),vec4((float(rand() % 101)) / 100,(float(rand() % 101)) / 100,(float(rand() % 101)) / 100, 0.0f) });
